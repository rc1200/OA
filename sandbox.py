...
ronDict = {'0133356728': {'price_canada': 58.7, 'Condition_canada': 'Used - Very Good', 'price_usa': 65, 'Condition_usa': 'something wrong happened'},
           '2222': {'price_canada': 50, 'Condition_canada': 'Used - Very Good', 'price_usa': 100, 'Condition_usa': 'xxx wrong happened'}}
...
df = df[(df.ProfitFactor1.between(0,1.11)) & (df.Condition_usa != 'something wrong happened')]
print('filtered df')
print(df)
